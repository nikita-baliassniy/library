...
(1, 'Неплохая книга для детской аудитории. Во взрослом возрасте перечитывать уже не рекомендую.', 1, 4),
...
(3, 'Прекрасное классическое произведение, стиль Уайльда непревзойден.', 1, 5);
