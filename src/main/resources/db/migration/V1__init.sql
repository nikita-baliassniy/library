...
VALUES ('Приключения Тома Сойера', 29.90,
        ...
        2018),
       ('Гарри Поттер и философский камень', 24.90,
        ...
        2020),
       ('Приключения Шерлока Холмса', 22.90, 'Сборник из 12 детективных рассказов, созданных Артуром Конаном Дойлом.',
        2015),
       ('Портрет Дориана Грея', 32.90,
