...
VALUES ('Приключения Тома Сойера', 229.90,
...
Группа, называющая себя «Б. Г.», работает точно и дерзко. Убит сибирский генерал-губернатор, убийца – человек, предъявивший документы на имя Эраста Фандорина. Эраст Петрович принимает вызов и берется за расследование. Кто стоит за буквами «Б. Г.»? Что сделало их террористами? Ради чего они совершают свои кровавые преступления?',
        2010),
       ('Коронация, или Последний из романов', 310.00,
        ...
        2010),
       ('Любовник смерти', 300.00,
        'Жила себе красавица с отцом и матерью. Вот и возраст подошел, сосватали ее. Но не суждено было счастью долго продлиться. В день свадьбы умер жених. Похоронили, убивалась невеста сильно. Погоревала, опять замуж собралась. Но перед венчанием и второй жених скончался. С кем бы ни жила девушка после, все умирали. Вот прозвали ее не иначе, как Смерть. Но недостатка в ухажерах она не испытывала. Вот и теперь Князь приударил, любовником Смерти стал. Долго ли ему землю топтать осталось?',
        2010),
...
VALUES (1, 'storage_repo/cover/1.jpg', 'storage_repo/fb2/1.fb2', 'storage_repo/pdf/1.pdf', 'storage_repo/epub/1.epub',
        'storage_repo/audio/1.mp3'),
       (2, 'storage_repo/cover/2.jpg', 'storage_repo/fb2/2.fb2', 'storage_repo/pdf/2.pdf', 'storage_repo/epub/2.epub',
        'storage_repo/audio/2.mp3'),
       (3, 'storage_repo/cover/3.jpg', 'storage_repo/fb2/3.fb2', 'storage_repo/pdf/3.pdf', 'storage_repo/epub/3.epub',
        'storage_repo/audio/3.mp3'),
       (4, 'storage_repo/cover/4.jpg', 'storage_repo/fb2/4.fb2', 'storage_repo/pdf/4.pdf', 'storage_repo/epub/4.epub',
        'storage_repo/audio/4.mp3'),
       (5, 'storage_repo/cover/5.jpg', 'storage_repo/fb2/5.fb2', 'storage_repo/pdf/5.pdf', 'storage_repo/epub/5.epub',
        'storage_repo/audio/3.mp3'),
       (6, 'storage_repo/cover/6.jpg', 'storage_repo/fb2/6.fb2', 'storage_repo/pdf/6.pdf', 'storage_repo/epub/6.epub',
        'storage_repo/audio/3.mp3'),
       (7, 'storage_repo/cover/7.jpg', 'storage_repo/fb2/7.fb2', 'storage_repo/pdf/7.pdf', 'storage_repo/epub/7.epub',
        'storage_repo/audio/3.mp3'),
       (8, 'storage_repo/cover/8.jpg', 'storage_repo/fb2/8.fb2', 'storage_repo/pdf/8.pdf', 'storage_repo/epub/8.epub',
        'storage_repo/audio/3.mp3'),
       (9, 'storage_repo/cover/9.jpg', 'storage_repo/fb2/9.fb2', 'storage_repo/pdf/9.pdf', 'storage_repo/epub/9.epub',
        'storage_repo/audio/3.mp3'),
       (10, 'storage_repo/cover/10.jpg', 'storage_repo/fb2/10.fb2', 'storage_repo/pdf/10.pdf',
        'storage_repo/epub/10.epub', 'storage_repo/audio/3.mp3'),
       (11, 'storage_repo/cover/11.jpg', 'storage_repo/fb2/11.fb2', 'storage_repo/pdf/11.pdf',
        'storage_repo/epub/11.epub', 'storage_repo/audio/3.mp3'),
       (12, 'storage_repo/cover/12.jpg', 'storage_repo/fb2/12.fb2', 'storage_repo/pdf/12.pdf',
        'storage_repo/epub/12.epub', 'storage_repo/audio/3.mp3'),
       (13, 'storage_repo/cover/13.jpg', 'storage_repo/fb2/13.fb2', 'storage_repo/pdf/13.pdf',
        'storage_repo/epub/13.epub', 'storage_repo/audio/3.mp3'),
       (14, 'storage_repo/cover/14.jpg', 'storage_repo/fb2/14.fb2', 'storage_repo/pdf/14.pdf',
        'storage_repo/epub/14.epub', 'storage_repo/audio/3.mp3'),
       (15, 'storage_repo/cover/15.jpg', 'storage_repo/fb2/15.fb2', 'storage_repo/pdf/15.pdf',
        'storage_repo/epub/15.epub', 'storage_repo/audio/3.mp3'),
       (16, 'storage_repo/cover/16.jpg', 'storage_repo/fb2/16.fb2', 'storage_repo/pdf/16.pdf',
        'storage_repo/epub/16.epub', 'storage_repo/audio/3.mp3'),
       (17, 'storage_repo/cover/17.jpg', 'storage_repo/fb2/17.fb2', 'storage_repo/pdf/17.pdf',
        'storage_repo/epub/17.epub', 'storage_repo/audio/3.mp3'),
       (18, 'storage_repo/cover/18.jpg', 'storage_repo/fb2/18.fb2', 'storage_repo/pdf/18.pdf',
        'storage_repo/epub/18.epub', 'storage_repo/audio/3.mp3'),
       (19, 'storage_repo/cover/19.jpg', 'storage_repo/fb2/19.fb2', 'storage_repo/pdf/19.pdf',
        'storage_repo/epub/19.epub', 'storage_repo/audio/3.mp3'),
       (20, 'storage_repo/cover/20.jpg', 'storage_repo/fb2/20.fb2', 'storage_repo/pdf/20.pdf',
        'storage_repo/epub/20.epub', 'storage_repo/audio/3.mp3'),
       (21, 'storage_repo/cover/21.jpg', 'storage_repo/fb2/21.fb2', 'storage_repo/pdf/21.pdf',
        'storage_repo/epub/21.epub', 'storage_repo/audio/3.mp3'),
       (22, 'storage_repo/cover/22.jpg', 'storage_repo/fb2/22.fb2', 'storage_repo/pdf/22.pdf',
        'storage_repo/epub/22.epub', 'storage_repo/audio/3.mp3'),
       (23, 'storage_repo/cover/23.jpg', 'storage_repo/fb2/23.fb2', 'storage_repo/pdf/23.pdf',
        'storage_repo/epub/23.epub', 'storage_repo/audio/3.mp3'),
       (24, 'storage_repo/cover/24.jpg', 'storage_repo/fb2/24.fb2', 'storage_repo/pdf/24.pdf',
        'storage_repo/epub/24.epub', 'storage_repo/audio/3.mp3'),
       (25, 'storage_repo/cover/25.jpg', 'storage_repo/fb2/25.fb2', 'storage_repo/pdf/25.pdf',
        'storage_repo/epub/25.epub', 'storage_repo/audio/3.mp3'),
       (26, 'storage_repo/cover/26.jpg', 'storage_repo/fb2/26.fb2', 'storage_repo/pdf/26.pdf',
        'storage_repo/epub/26.epub', 'storage_repo/audio/3.mp3'),
       (27, 'storage_repo/cover/27.jpg', 'storage_repo/fb2/27.fb2', 'storage_repo/pdf/27.pdf',
        'storage_repo/epub/27.epub', 'storage_repo/audio/3.mp3'),
       (28, 'storage_repo/cover/28.jpg', 'storage_repo/fb2/28.fb2', 'storage_repo/pdf/28.pdf',
        'storage_repo/epub/28.epub', 'storage_repo/audio/3.mp3'),
       (29, 'storage_repo/cover/29.jpg', 'storage_repo/fb2/29.fb2', 'storage_repo/pdf/29.pdf',
        'storage_repo/epub/29.epub', 'storage_repo/audio/3.mp3'),
       (30, 'storage_repo/cover/30.jpg', 'storage_repo/fb2/30.fb2', 'storage_repo/pdf/30.pdf',
        'storage_repo/epub/30.epub', 'storage_repo/audio/3.mp3');

INSERT INTO comments (book_id, text, user_id, score)
VALUES (1, 'Неплохая книга для детской аудитории. Во взрослом возрасте перечитывать уже не рекомендую.', 1, 3),
       ...
       (28, 'Отличная книга для детей на сложные темы', 4, 5);

INSERT INTO authors (name, date_of_birth, biography, country)
VALUES ('Марк Твен', '1835-11-30',
       ...
       ('Борис Акунин', '1956-05-20',
        ...
        'Россия'),
       ('Дэн Браун', '1964-06-22',
        'Американский писатель, журналист, музыкант. Из-под его пера вышли такие бестселлеры, как «Ангелы и демоны», «Код да Винчи», «Утраченный символ» и «Инферно», рассказывающие о тайных обществах, символике, заговорах. Его первый роман «Цифровая крепость» посвящён деятельности Агентства национальной безопасности США.',
        'США'),
       ...
       ('Маргарет Митчелл', '1900-11-08', 'Американская писательница и журналистка, автор романа «Унесённые ветром».',
        'США'),
       ('Джоджо Мойес', '1969-08-04',
        'Английская романистка и журналистка, двукратная обладательница премии Ассоциации романтических новеллистов в номинации «Романтическая новелла года» за романы «Заморские фрукты» и «Последнее письмо от твоего любимого».',
        'Великобритания'),
       ('Татьяна Устинова', '1968-04-21',
        'Современная российская писательница, сценаристка, переводчица и радиоведущая.',
        'Россия'),
       ('Бодо Шефер', '1960-09-10', 'Современный немецкий эксперт по финансовым вопросам, бизнес-коуч, автор книг.',
        'Германия'),
       ('Диана Уинн Джонс', '1934-03-26',
        'Британская писательница, автор фантастических романов для детей и взрослых. Наиболее известные работы — это серия книг о Крестоманси и роман «Ходячий замок», а также «Темный Властелин Деркхольма».',
        'Великобритания');
